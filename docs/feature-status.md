...
| Advanced Builder preservation during Quick Start rollout | Verified complete (preserved, not extracted) | `frontend/app/new-story.tsx` | `frontend/__tests__/new-story.test.tsx` ✅, browser preview regression ✅ | `current-state.md` | Still a large screen file; Phase 4 extraction pending | Refactor later without changing contract |
